...
Dataset preparation, report generation, release packaging, cluster maintenance, and other local utilities are kept out of the official repository. The remote repository keeps training-facing code plus launchers that include recommended hyperparameters without private machine paths.
