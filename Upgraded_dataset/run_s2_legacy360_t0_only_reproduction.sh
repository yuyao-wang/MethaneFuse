...
CHECKPOINT_ROOT="/transferdiniu2/yuyao/checkpoints/s2_legacy360_matched_gee_t0_only_20260728"
...
run_split() {
  ...
  local run_name="s2_legacy360_matched_gee_t0_only_${split_name}_full_finetune"
  local log_path="${RESULT_ROOT}/${split_name}.t0_only.log"
  local metrics_path="${RESULT_ROOT}/${split_name}.t0_only.metrics.jsonl"
