...
CHECKPOINT_ROOT="/transferdiniu2/yuyao/checkpoints/s2_legacy360_matched_gee_reproduction_20260728"
...
run_split() {
  ...
  local run_name="s2_legacy360_matched_gee_${split_name}_full_finetune"
  local log_path="${RESULT_ROOT}/${split_name}.log"
  local metrics_path="${RESULT_ROOT}/${split_name}.metrics.jsonl"
