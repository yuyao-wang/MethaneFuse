...
OUT_DIR = Path("/mnt/engg-leung/Research_No9_Methane_Emissions/Yuyao/Dataset/datasets_480m_cluster_split")
TRAIN_OUT = "manifest_time_train_480m_macroregion_by_plume.csv"
TEST_OUT = "manifest_time_test_480m_macroregion_by_plume.csv"
FIG_PNG = Path("/home/yuyao/panopticon/Pictures/480m_macroregion_split_map.png")
FIG_PDF = Path("/home/yuyao/panopticon/Pictures/480m_macroregion_split_map.pdf")
...
def plot_map(sample_df: pd.DataFrame) -> None:
    ...
    # ax.set_title("Spatially blocked train/test split for 480 m plume samples", pad=6)
