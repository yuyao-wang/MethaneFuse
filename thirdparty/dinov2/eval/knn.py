...
from thirdparty.dinov2.data import SamplerType, make_data_loader
from thirdparty.dinov2.eval.metrics import build_metric
from thirdparty.dinov2.eval.utils import evaluate, extract_features, get_num_classes
