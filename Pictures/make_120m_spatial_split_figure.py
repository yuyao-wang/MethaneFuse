...
TRAIN_CSV = "/mnt/engg-leung/Research_No9_Methane_Emissions/Yuyao/finalDataset_query/legacy_param_120m/manifest_time_train.csv"
TEST_CSV = "/mnt/engg-leung/Research_No9_Methane_Emissions/Yuyao/finalDataset_query/legacy_param_120m/manifest_time_test.csv"

OUT_DIR = Path("/mnt/engg-leung/Research_No9_Methane_Emissions/Yuyao/Dataset/datasets_120m_cluster_split")
TRAIN_OUT = "manifest_time_train_120m_macroregion_by_plume.csv"
TEST_OUT = "manifest_time_test_120m_macroregion_by_plume.csv"
FIG_PNG = Path("/home/yuyao/panopticon/Pictures/120m_macroregion_split_map.png")
FIG_PDF = Path("/home/yuyao/panopticon/Pictures/120m_macroregion_split_map.pdf")
...
def plot_map(sample_df: pd.DataFrame) -> None:
    ...
    # ax.set_title("Spatially blocked train/test split for 120 m plume samples", pad=6)
